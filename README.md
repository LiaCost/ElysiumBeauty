...
Telas disponíveis:
Home - Apresentação dos serviços e informações gerais
Login - Acesso de clientes e administradores
Agendamento - Seleção de serviço, data e horário
Dashboard (Administrador) - Visão geral da plataforma
Relatórios - Visualização de métricas e agendamentos
